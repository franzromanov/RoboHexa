...
const unsigned int offsetServoCoxa[6]={120,90,90,120,90,90}; //zero offset servo C,B,F,D,A,E (coxa C rusak)
const unsigned int offsetServoFemur[6]={75,90,85,90,90,85};   //zero offset servo C,B,F,D,A,E (femur C rusak)
